...
01 WSC-SEM-EARNED            PIC 999V99  VALUE ZERO.
    ...
    PERFORM UNTIL EOF = "Y"
        IF EOF = "N" THEN
            ...
            IF SEMESTER = WS-SEMESTER THEN
                PERFORM UPDATE-SEMESTER-EARNED
                PERFORM UPDATE-SEMESTER-QPTS
...
SET-QPTS.
    IF WS-GRADE IS EQUAL TO "A" THEN
        COMPUTE WSC-QPTS = WSC-EARNED * 4
    ELSE IF WS-GRADE IS EQUAL TO "B" THEN
        COMPUTE WSC-QPTS = WSC-EARNED * 3
    ELSE IF WS-GRADE IS EQUAL TO "C" THEN
        COMPUTE WSC-QPTS = WSC-EARNED * 2
    ELSE IF WS-GRADE IS EQUAL TO "D" THEN
        COMPUTE WSC-QPTS = WSC-EARNED * 1
    ELSE        
        MOVE 0 TO WSC-QPTS
    END-IF.
...
UPDATE-SEMESTER-EARNED.
    COMPUTE WSC-SEM-EARNED = WSC-SEM-EARNED + WSC-EARNED.

UPDATE-SEMESTER-QPTS.

CALCULATE-EOS-TOTALS.
    MOVE WSC-SEM-EARNED TO OUT-SEMESTER-EARNED.
