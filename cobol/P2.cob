...
*> WS-COMP FIELDS ARE USED FOR COMPUTATION THEN MOVED TO ASSOCIATED WS FIELD.
01 WS-COMP-QPTS         PIC 999V99.
...
SET-QPTS.
    MOVE WS-EARNED TO WS-COMP-QPTS.

    IF WS-GRADE IS EQUAL TO "A" THEN
        COMPUTE WS-COMP-QPTS = WS-COMP-QPTS * 4
    ELSE IF WS-GRADE IS EQUAL TO "B" THEN
        COMPUTE WS-COMP-QPTS = WS-COMP-QPTS * 3
    ELSE IF WS-GRADE IS EQUAL TO "C" THEN
        COMPUTE WS-COMP-QPTS = WS-COMP-QPTS * 2
    ELSE IF WS-GRADE IS EQUAL TO "D" THEN
        COMPUTE WS-COMP-QPTS = WS-COMP-QPTS * 1
    ELSE        
        MOVE 0 TO WS-COMP-QPTS
    END-IF.

    MOVE WS-COMP-QPTS TO WS-QPTS.
